...
0000000000400efc <phase_2>:
  ...
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp)				#看看read6对rsp干了什么
  400f0e:	74 20                	je     400f30 <phase_2+0x34>    #*rsp==1  则令rbx=rsp+4 rbp=rsp+24
  400f10:	e8 25 05 00 00       	call   40143a <explode_bomb>    #不等就炸
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>	#
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax          #循环开始 eax=*（rbx-4）   下一个数组元素        
  ...
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx			#rsp+4字节 给rbx      f17处又减了4  比的是原数*2和下一个数是否相等
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp
  400f3a:	eb db                	jmp    400f17 <phase_2+0x1b>    #循环结束
...
0000000000400f43 <phase_3>:
  ...
  400f47:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx							 #(rsp+12) rcx
  400f4c:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx							 #(rsp+8)  rdx 都是用来接受scanf的输入
  400f51:	be cf 25 40 00       	mov    $0x4025cf,%esi							 # "%d %d"
  400f56:	b8 00 00 00 00       	mov    $0x0,%eax								 #
  400f5b:	e8 90 fc ff ff       	call   400bf0 <__isoc99_sscanf@plt>				 #return是成功赋值的项数
  400f60:	83 f8 01             	cmp    $0x1,%eax								 # 计算eax-1
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>					 #eax大于1才跳
  400f65:	e8 d0 04 00 00       	call   40143a <explode_bomb>					 #要不然就炸
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)							 #
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>					 #第一位大于7就炸
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax							 #
  400f75:	ff 24 c5 70 24 40 00 	jmp    *0x402470(,%rax,8)						 #0x402470+8*rax 即8*7 跳到哪去了
  400f7c:	b8 cf 00 00 00       	mov    $0xcf,%eax								 #eax是0xcf
  ...
  400fad:	e8 88 04 00 00       	call   40143a <explode_bomb>					 #炸
  400fb2:	b8 00 00 00 00       	mov    $0x0,%eax								 #
  400fb7:	eb 05                	jmp    400fbe <phase_3+0x7b>					 #
  400fb9:	b8 37 01 00 00       	mov    $0x137,%eax								 #
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax							 #
  400fc2:	74 05                	je     400fc9 <phase_3+0x86>					 #一样就ret了
...
000000000040131b <string_length>:
  40131b:	80 3f 00             	cmpb   $0x0,(%rdi)									#rdi为equal的第一个参数
  40131e:	74 12                	je     401332 <string_length+0x17>                  #寻址值为0就返回0
  401320:	48 89 fa             	mov    %rdi,%rdx
  401323:	48 83 c2 01          	add    $0x1,%rdx									#循环开始 备份地址+1
  401327:	89 d0                	mov    %edx,%eax
  401329:	29 f8                	sub    %edi,%eax									#备份地址减原地址 相当于记录循环次数
  40132b:	80 3a 00             	cmpb   $0x0,(%rdx)									#cmbp比较八位
  40132e:	75 f3                	jne    401323 <string_length+0x8>					#循环结束条件 char==0x0 即'\0'
...
0000000000401338 <strings_not_equal>:
  ...
  40133a:	55                   	push   %rbp
  40133b:	53                   	push   %rbx
  40133c:	48 89 fb             	mov    %rdi,%rbx									#caller的第一个参数进rbx
  40133f:	48 89 f5             	mov    %rsi,%rbp
  401342:	e8 d4 ff ff ff       	call   40131b <string_length>						#第一个参数的长度
  401347:	41 89 c4             	mov    %eax,%r12d									#
  40134a:	48 89 ef             	mov    %rbp,%rdi									#
  40134d:	e8 c9 ff ff ff       	call   40131b <string_length>						#第二个参数的长度
  401352:	ba 01 00 00 00       	mov    $0x1,%edx									#
  401357:	41 39 c4             	cmp    %eax,%r12d									#比较两参数长度
  40135a:	75 3f                	jne    40139b <strings_not_equal+0x63>				#不一样长  爆
  40135c:	0f b6 03             	movzbl (%rbx),%eax									#rbx没被覆盖过 里面第一个参数 
  40135f:	84 c0                	test   %al,%al										#看低位第一个字节 
																						#length函数可能越界了才找到'\0'现在看原参数末尾是不是0 确定没越界
  401361:	74 25                	je     401388 <strings_not_equal+0x50>				#空字符就跳  return 0
  401363:	3a 45 00             	cmp    0x0(%rbp),%al								#
  401366:	74 0a                	je     401372 <strings_not_equal+0x3a>				#
  401368:	eb 25                	jmp    40138f <strings_not_equal+0x57>				#
  40136a:	3a 45 00             	cmp    0x0(%rbp),%al								#循环开始
  40136d:	0f 1f 00             	nopl   (%rax)										#
  401370:	75 24                	jne    401396 <strings_not_equal+0x5e>				#不等就跳return 1
  401372:	48 83 c3 01          	add    $0x1,%rbx									#第一个参数地址加1
  401376:	48 83 c5 01          	add    $0x1,%rbp									#第二个参数地址加一
  40137a:	0f b6 03             	movzbl (%rbx),%eax									#
  40137d:	84 c0                	test   %al,%al										#
  40137f:	75 e9                	jne    40136a <strings_not_equal+0x32>              #往回了 是循环！ 这行以上是逐个字节对比
  ...
  40139b:	89 d0                	mov    %edx,%eax									#前面几行的edx就是返回值
  40139d:	5b                   	pop    %rbx											#
  40139e:	5d                   	pop    %rbp
  40139f:	41 5c                	pop    %r12
  4013a1:	c3                   	ret													#进defuse函数
...
000000000040145c <read_six_numbers>:
  ...
  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx			#4     rcx
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax         
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp)			#20  （rsp+8）
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax          #16   （rsp）  后两个放栈里
